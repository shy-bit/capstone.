...
$PHPMAILER_LANG['buggy_php']            = 'Din version af PHP er berÃ¸rt af en fejl, som gÃ¸r at dine beskeder muligvis vises forkert. For at rette dette kan du skifte til SMTP, slÃ¥ mail.add_x_header headeren i din php.ini fil fra, skifte til MacOS eller Linux eller opgradere din version af PHP til 7.0.17+ eller 7.1.3+.';
...
$PHPMAILER_LANG['file_access']          = 'Kunne ikke tilgÃ¥ filen: ';
...
$PHPMAILER_LANG['invalid_header']       = 'Ugyldig header navn eller vÃ¦rdi';
$PHPMAILER_LANG['invalid_hostentry']    = 'Ugyldig hostentry: ';
$PHPMAILER_LANG['invalid_host']         = 'Ugyldig vÃ¦rt: ';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP fejl: FÃ¸lgende modtagere fejlede: ';
